...
then
  ...
  GET_USER_GAMES_DATA="$($PSQL "SELECT COUNT(*), MIN(number_guesses) FROM games WHERE user_id = $USER_ID;")"
...
#insert new game
INSERT_NEW_GAME="$($PSQL "INSERT INTO games(user_id, number_guesses) VALUES($USER_ID, '$NUMBER_OF_GUESSES');")"
